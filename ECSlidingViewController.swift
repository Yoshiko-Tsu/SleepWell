...
class ECSlidingViewController: UIViewController, UIViewControllerContextTransitioning, UIViewControllerTransitionCoordinator, UIViewControllerTransitionCoordinatorContext {
   ...
   var anchorLeftRevealAmount: CGFloat = 276
    ...
    func setTopViewControllerWithStoryboardID(sbID: String) {
        self.set_TopViewController(self.storyboard!.instantiateViewControllerWithIdentifier(sbID) as! UIViewController)
    }
    
    func set_TopViewController(topViewController: UIViewController) {
    ...
    func set_UnderLeftViewController(underLeftViewController: UIViewController) {
    ...
    func set_UnderRightViewController(underRightViewController: UIViewController) {
    ...
    func set_AnchorRightRevealAmount(anchorRightRevealAmount: CGFloat) {
