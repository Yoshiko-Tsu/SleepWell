...
//
    func insertRowsAtIndexPathsOrg(indexPaths: [AnyObject], withRowAnimation animation: UITableViewRowAnimation) {
        super.insertRowsAtIndexPaths(indexPaths, withRowAnimation: animation)
        //showOrHideBackgroundViewAnimatedly(true)
    }
    func deleteRowsAtIndexPathsOrg(indexPaths: [AnyObject], withRowAnimation animation: UITableViewRowAnimation) {
